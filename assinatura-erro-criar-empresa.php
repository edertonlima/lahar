...
<body>
	<div class="w-section" id="trial" data-ix="jasou-e-experimente-aparece">
		<div class="menu_top">
			<div class="w-nav nav_cinza" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1">
				<div class="w-row">
					<div class="w-col w-col-2 w-col-small-2 coluna_1"></div>
					<div class="w-col w-col-2 w-col-small-2 w-clearfix coluna_navmenu">
						<div class="w-nav-button menu_button">
							<div class="w-icon-nav-menu icon_navbar"></div>
						</div>
						<a class="w-nav-brand logo_menu" href="/"><img src="images/logo-header.png" width="159" style="padding-bottom: 15px;"></a>
					</div>
					<div class="w-col w-col-6 w-col-small-6 w-clearfix coluna_navmenu">
						<span class="telefone_top">Dúvidas? Ligue para nossa Central de Vendas <strong>(14) 3010-3330</strong></span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="w-section">
		<div class="w-container" data-ix="fade-scroll">
			...
			<div class="etapa-assinatura">
				<div class="w-col w-col-3 etapa etapa1 etapa-ok">
					<span class="ico-etapa">1</span>
					<div class="tit-etapa">Seus Dados</div>
				</div>
				<div class="w-col w-col-3 etapa etapa2 etapa-erro active">
			...
			<form>
				<div id="etapa4" class="w-row box-etapa" style="display: block;">
						<fieldset class="w-col w-col-12 center">
							<h2 class="erro"><i class="fa fa-exclamation-triangle" aria-hidden="true" style="font-size:60px;"></i> Erro ao registrar seus dados informados!</h2>
							<p>Infelizmente não conseguimos registrar seus dados. Por favor, tente novamente e se o problema persistir favor entrar em contato.</p>
						</fieldset>
						<fieldset class="w-col w-col-12 center action">
							<a href="assinar" class="w-button button verde big"><i class="fa fa-arrow-left" aria-hidden="true"></i> Tentar novamente</a>
						</fieldset>
					</button>
				</fieldset>
			</form>
			...
			<div class="w-row" style="padding-bottom: 107px;  padding-top: 35px;">
				...
				<div class="w-col w-col-14" style="text-align: center; float: right;">
